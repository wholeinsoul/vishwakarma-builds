...
export async function readPrescription(imageUrl: string): Promise<PrescriptionResult> {
  ...
  let parsed: { doctor_name?: string; prescription_date?: string; medications?: ParsedMedication[] };
  try {
