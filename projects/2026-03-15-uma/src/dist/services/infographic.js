...
function buildMedicationRow(med) {
...
function buildInfographicMarkup(data) {
            ...
            children: [
                ...
                },
                {
                    ...
                    props: {
                        ...
                        children: '⚠️ यह चिकित्सा सलाह नहीं है। अपने डॉक्टर से परामर्श लें। | This is not medical advice. Consult your doctor.',
                    },
                },
            ],
        },
...
export async function generateInfographic(data) {
    ...
    if (fontData.length > 0) {
        fonts = [
            { name: 'NotoSans', data: fontData, weight: 400, style: 'normal' },
        ];
        if (fontBoldData.length > 0) {
            fonts.push({ name: 'NotoSans', data: fontBoldData, weight: 700, style: 'normal' });
        }
    }
    if (fonts.length === 0) {
        throw new Error('Font files not found. Place NotoSansDevanagari-Regular.ttf in fonts/ directory.');
    }
