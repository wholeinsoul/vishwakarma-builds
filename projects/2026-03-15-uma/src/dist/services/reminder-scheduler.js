...
async function processReminders() {
    try {
        ...
        for (const reminder of dueReminders) {
            ...
            if (!medication)
                continue;
            const text = messages.reminderMessage(medication.drug_name_hi || medication.drug_name_en, medication.drug_name_en, medication.dosage || '', medication.instructions || '');
            try {
